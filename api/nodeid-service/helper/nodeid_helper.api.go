...
import (
	...
	nodeiderrorv1 "github.com/go-micro-saas/nodeid-service/api/nodeid-service/v1/errors"
	nodeidresourcev1 "github.com/go-micro-saas/nodeid-service/api/nodeid-service/v1/resources"
	nodeidservicev1 "github.com/go-micro-saas/nodeid-service/api/nodeid-service/v1/services"
...
type nodeIDHelper struct {
	opts      *options
	log       *log.Helper
	nodeidSrv nodeidservicev1.SrvNodeIDV1Server
}
...
func NewNodeIDHelper(nodeidSrv nodeidservicev1.SrvNodeIDV1Server, opts ...Option) NodeIDHelper {
	...
	return &nodeIDHelper{opts: o, log: logHelper, nodeidSrv: nodeidSrv}
}
...
func (s *nodeIDHelper) GetNodeID(ctx context.Context, req *nodeidresourcev1.GetNodeIdReq) (*nodeidresourcev1.GetNodeIdRespData, error) {
	resp, err := s.nodeidSrv.GetNodeId(ctx, req)
	if err != nil {
		if s.opts.tries <= 1 {
			return nil, err
...
func (s *nodeIDHelper) renewalNodeID(ctx context.Context, req *nodeidresourcev1.RenewalNodeIdReq) (*nodeidresourcev1.RenewalNodeIdRespData, error) {
	resp, err := s.nodeidSrv.RenewalNodeId(ctx, req)
	if err != nil {
		if s.opts.tries <= 1 {
			return nil, err
			//return nil, errorpkg.FormatError(err)
...
func (s *nodeIDHelper) ReleaseNodeId(ctx context.Context, dataModel *nodeidresourcev1.GetNodeIdRespData) (*nodeidresourcev1.ReleaseNodeIdRespData, error) {
	...
	resp, err := s.nodeidSrv.ReleaseNodeId(ctx, req)
	if err != nil {
		if s.opts.tries <= 1 {
			return nil, err
			//return nil, errorpkg.FormatError(err)
