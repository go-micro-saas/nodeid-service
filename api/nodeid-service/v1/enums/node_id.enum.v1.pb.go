...
type NodeEventStatusEnum_NodeEventStatus int32

const (
	NodeEventStatusEnum_UNSPECIFIED   NodeEventStatusEnum_NodeEventStatus = 0 // 未指定
	NodeEventStatusEnum_SUCCESS       NodeEventStatusEnum_NodeEventStatus = 1 // 成功
	NodeEventStatusEnum_FAILED        NodeEventStatusEnum_NodeEventStatus = 2 // 失败的状态
	NodeEventStatusEnum_TRYING        NodeEventStatusEnum_NodeEventStatus = 3 // 重试中
	NodeEventStatusEnum_RETRY_SUCCESS NodeEventStatusEnum_NodeEventStatus = 4 // 重试成功
	NodeEventStatusEnum_RETRY_FAILED  NodeEventStatusEnum_NodeEventStatus = 5 // 重试失败
)

// Enum value maps for NodeEventStatusEnum_NodeEventStatus.
var (
	NodeEventStatusEnum_NodeEventStatus_name = map[int32]string{
		0: "UNSPECIFIED",
		1: "SUCCESS",
		2: "FAILED",
		3: "TRYING",
	...
	NodeEventStatusEnum_NodeEventStatus_value = map[string]int32{
		"UNSPECIFIED":   0,
		"SUCCESS":       1,
		"FAILED":        2,
		"TRYING":        3,
...
func (x NodeEventStatusEnum_NodeEventStatus) Enum() *NodeEventStatusEnum_NodeEventStatus {
	p := new(NodeEventStatusEnum_NodeEventStatus)
	*p = x
	return p
}

func (x NodeEventStatusEnum_NodeEventStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (NodeEventStatusEnum_NodeEventStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_api_nodeid_service_v1_enums_node_id_enum_v1_proto_enumTypes[1].Descriptor()
}

func (NodeEventStatusEnum_NodeEventStatus) Type() protoreflect.EnumType {
	return &file_api_nodeid_service_v1_enums_node_id_enum_v1_proto_enumTypes[1]
}

func (x NodeEventStatusEnum_NodeEventStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use NodeEventStatusEnum_NodeEventStatus.Descriptor instead.
func (NodeEventStatusEnum_NodeEventStatus) EnumDescriptor() ([]byte, []int) {
	return file_api_nodeid_service_v1_enums_node_id_enum_v1_proto_rawDescGZIP(), []int{1, 0}
}
...
type NodeEventStatusEnum struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *NodeEventStatusEnum) Reset() {
	*x = NodeEventStatusEnum{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_nodeid_service_v1_enums_node_id_enum_v1_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *NodeEventStatusEnum) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NodeEventStatusEnum) ProtoMessage() {}

func (x *NodeEventStatusEnum) ProtoReflect() protoreflect.Message {
	mi := &file_api_nodeid_service_v1_enums_node_id_enum_v1_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NodeEventStatusEnum.ProtoReflect.Descriptor instead.
func (*NodeEventStatusEnum) Descriptor() ([]byte, []int) {
	return file_api_nodeid_service_v1_enums_node_id_enum_v1_proto_rawDescGZIP(), []int{1}
}
...
var file_api_nodeid_service_v1_enums_node_id_enum_v1_proto_rawDesc = []byte{
	...
	0x4c, 0x45, 0x10, 0x01, 0x12, 0x09, 0x0a, 0x05, 0x55, 0x53, 0x49, 0x4e, 0x47, 0x10, 0x02, 0x22,
	0x83, 0x01, 0x0a, 0x13, 0x4e, 0x6f, 0x64, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x45, 0x6e, 0x75, 0x6d, 0x22, 0x6c, 0x0a, 0x0f, 0x4e, 0x6f, 0x64, 0x65, 0x45,
	...
	0x4c, 0x45, 0x44, 0x10, 0x05, 0x42, 0x7b, 0x0a, 0x16, 0x73, 0x61, 0x61, 0x73, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x6e, 0x6f, 0x64, 0x65, 0x69, 0x64, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x76, 0x31, 0x42,
	0x13, 0x53, 0x61, 0x61, 0x73, 0x41, 0x70, 0x69, 0x4e, 0x6f, 0x64, 0x65, 0x69, 0x64, 0x45, 0x6e,
	0x75, 0x6d, 0x56, 0x31, 0x50, 0x01, 0x5a, 0x4a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_api_nodeid_service_v1_enums_node_id_enum_v1_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_api_nodeid_service_v1_enums_node_id_enum_v1_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_api_nodeid_service_v1_enums_node_id_enum_v1_proto_goTypes = []any{
	(NodeIDStatusEnum_Status)(0),             // 0: saas.api.nodeid.enumv1.NodeIDStatusEnum.Status
	(NodeEventStatusEnum_NodeEventStatus)(0), // 1: saas.api.nodeid.enumv1.NodeEventStatusEnum.NodeEventStatus
	(*NodeIDStatusEnum)(nil),                 // 2: saas.api.nodeid.enumv1.NodeIDStatusEnum
	(*NodeEventStatusEnum)(nil),              // 3: saas.api.nodeid.enumv1.NodeEventStatusEnum
}
...
func file_api_nodeid_service_v1_enums_node_id_enum_v1_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_nodeid_service_v1_enums_node_id_enum_v1_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_api_nodeid_service_v1_enums_node_id_enum_v1_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*NodeEventStatusEnum); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
