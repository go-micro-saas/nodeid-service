...
var file_api_uuid_service_v1_errors_uuid_error_v1_proto_goTypes = []interface{}{
...
func file_api_uuid_service_v1_errors_uuid_error_v1_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_uuid_service_v1_errors_uuid_error_v1_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*README); i {
			case 0:
				return &v.state
			case 1:
