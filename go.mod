...
require (
	...
	github.com/ThreeDotsLabs/watermill-amqp/v2 v2.1.2 // indirect
	...
	github.com/go-kratos/kratos/contrib/registry/etcd/v2 v2.0.0-20240819025634-57b961cba04c // indirect
