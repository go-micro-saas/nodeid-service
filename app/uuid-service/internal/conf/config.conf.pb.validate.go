...
func (m *ServiceConfig) validate(all bool) error {
	...
	if all {
		switch v := interface{}(m.GetUuidService()).(type) {
	...
	} else if v, ok := interface{}(m.GetUuidService()).(interface{ Validate() error }); ok {
		if err := v.Validate(); err != nil {
...
// Validate checks the field values on ServiceConfig_UuidService with the rules
...
// ValidateAll checks the field values on ServiceConfig_UuidService with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ServiceConfig_UuidServiceMultiError, or nil if none found.
func (m *ServiceConfig_UuidService) ValidateAll() error {
	return m.validate(true)
}

func (m *ServiceConfig_UuidService) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if utf8.RuneCountInString(m.GetInstanceId()) < 1 {
		err := ServiceConfig_UuidServiceValidationError{
			field:  "InstanceId",
	...
	if len(errors) > 0 {
		return ServiceConfig_UuidServiceMultiError(errors)
	}

	return nil
}

// ServiceConfig_UuidServiceMultiError is an error wrapping multiple validation
// errors returned by ServiceConfig_UuidService.ValidateAll() if the
// designated constraints aren't met.
type ServiceConfig_UuidServiceMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ServiceConfig_UuidServiceMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ServiceConfig_UuidServiceMultiError) AllErrors() []error { return m }

// ServiceConfig_UuidServiceValidationError is the validation error returned by
// ServiceConfig_UuidService.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e ServiceConfig_UuidServiceValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ServiceConfig_UuidServiceValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ServiceConfig_UuidServiceValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ServiceConfig_UuidServiceValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ServiceConfig_UuidServiceValidationError) ErrorName() string {
	return "ServiceConfig_UuidServiceValidationError"
}

// Error satisfies the builtin error interface
func (e ServiceConfig_UuidServiceValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sServiceConfig_UuidService.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ServiceConfig_UuidServiceValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ServiceConfig_UuidServiceValidationError{}
