...
var file_app_uuid_service_internal_conf_config_conf_proto_goTypes = []interface{}{
...
func file_app_uuid_service_internal_conf_config_conf_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_app_uuid_service_internal_conf_config_conf_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_app_uuid_service_internal_conf_config_conf_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
