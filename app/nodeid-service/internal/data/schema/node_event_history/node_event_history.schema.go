...
// NodeEventHistorySchema NodeEventHistory
var NodeEventHistorySchema NodeEventHistory

// NewNodeEventHistory new schema
func NewNodeEventHistory() *NodeEventHistory {
	return &NodeEventHistory{}
}

const (
	TableName = "nid_node_event_history"
...
func (s *NodeEventHistory) TableName() string {
	return TableName
}

// CreateTableMigrator create table migrator
func (s *NodeEventHistory) CreateTableMigrator(migrator gorm.Migrator) migrationuitl.MigrationInterface {
	return migrationuitl.NewCreateTable(migrator, migrationuitl.Version, s)
}

// DropTableMigrator create table migrator
func (s *NodeEventHistory) DropTableMigrator(migrator gorm.Migrator) migrationuitl.MigrationInterface {
	return migrationuitl.NewDropTable(migrator, migrationuitl.Version, s)
}

// TableSQL table SQL
func (s *NodeEventHistory) TableSQL() string {
	return `
create table nid_node_event_history (
