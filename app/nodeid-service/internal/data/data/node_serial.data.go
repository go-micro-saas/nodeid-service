...
// create insert one
func (s *nodeSerialRepo) create(ctx context.Context, dbConn *gorm.DB, dataModel *po.NodeSerial) (err error) {
...
// Create insert one
func (s *nodeSerialRepo) Create(ctx context.Context, dataModel *po.NodeSerial) error {
	return s.create(ctx, s.dbConn, dataModel)
}

// CreateWithDBConn create
func (s *nodeSerialRepo) CreateWithDBConn(ctx context.Context, dbConn *gorm.DB, dataModel *po.NodeSerial) error {
...
// ExistCreate exist create
func (s *nodeSerialRepo) ExistCreate(ctx context.Context, dataModel *po.NodeSerial) (anotherModel *po.NodeSerial, isNotFound bool, err error) {
	return s.existCreate(ctx, s.dbConn, dataModel)
}

// ExistCreateWithDBConn exist create
func (s *nodeSerialRepo) ExistCreateWithDBConn(ctx context.Context, dbConn *gorm.DB, dataModel *po.NodeSerial) (anotherModel *po.NodeSerial, isNotFound bool, err error) {
	return s.existCreate(ctx, dbConn, dataModel)
}

// createInBatches create many
func (s *nodeSerialRepo) createInBatches(ctx context.Context, dbConn *gorm.DB, dataModels []*po.NodeSerial, batchSize int) (err error) {
	err = dbConn.WithContext(ctx).
		Table(s.NodeSerialSchema.TableName()).
...
// CreateInBatches create many
func (s *nodeSerialRepo) CreateInBatches(ctx context.Context, dataModels []*po.NodeSerial, batchSize int) error {
	return s.createInBatches(ctx, s.dbConn, dataModels, batchSize)
}

// CreateInBatchesWithDBConn create many
func (s *nodeSerialRepo) CreateInBatchesWithDBConn(ctx context.Context, dbConn *gorm.DB, dataModels []*po.NodeSerial, batchSize int) error {
...
// update update
func (s *nodeSerialRepo) update(ctx context.Context, dbConn *gorm.DB, dataModel *po.NodeSerial) (err error) {
	err = dbConn.WithContext(ctx).
		Table(s.NodeSerialSchema.TableName()).
		// Where(schemas.FieldId+" = ?", dataModel.Id).
...
// Update update
func (s *nodeSerialRepo) Update(ctx context.Context, dataModel *po.NodeSerial) error {
	return s.update(ctx, s.dbConn, dataModel)
}

// UpdateWithDBConn update
func (s *nodeSerialRepo) UpdateWithDBConn(ctx context.Context, dbConn *gorm.DB, dataModel *po.NodeSerial) error {
...
// ExistUpdate exist update
func (s *nodeSerialRepo) ExistUpdate(ctx context.Context, dataModel *po.NodeSerial) (anotherModel *po.NodeSerial, isNotFound bool, err error) {
	return s.existUpdate(ctx, s.dbConn, dataModel)
}

// ExistUpdateWithDBConn exist update
func (s *nodeSerialRepo) ExistUpdateWithDBConn(ctx context.Context, dbConn *gorm.DB, dataModel *po.NodeSerial) (anotherModel *po.NodeSerial, isNotFound bool, err error) {
...
func (s *nodeSerialRepo) queryOneById(ctx context.Context, dbConn *gorm.DB, id interface{}) (dataModel *po.NodeSerial, isNotFound bool, err error) {
...
// QueryOneById query one by id
func (s *nodeSerialRepo) QueryOneById(ctx context.Context, id interface{}) (dataModel *po.NodeSerial, isNotFound bool, err error) {
...
func (s *nodeSerialRepo) queryOneByConditions(ctx context.Context, dbConn *gorm.DB, conditions map[string]interface{}) (dataModel *po.NodeSerial, isNotFound bool, err error) {
	dataModel = new(po.NodeSerial)
...
// QueryOneByConditions query one by conditions
func (s *nodeSerialRepo) QueryOneByConditions(ctx context.Context, conditions map[string]interface{}) (dataModel *po.NodeSerial, isNotFound bool, err error) {
	return s.queryOneByConditions(ctx, s.dbConn, conditions)
}

// QueryOneByConditionsWithDBConn query one by conditions
func (s *nodeSerialRepo) QueryOneByConditionsWithDBConn(ctx context.Context, dbConn *gorm.DB, conditions map[string]interface{}) (dataModel *po.NodeSerial, isNotFound bool, err error) {
...
func (s *nodeSerialRepo) queryAllByConditions(ctx context.Context, dbConn *gorm.DB, conditions map[string]interface{}) (dataModels []*po.NodeSerial, err error) {
	dbConn = dbConn.WithContext(ctx).Table(s.NodeSerialSchema.TableName())
	err = s.WhereConditions(dbConn, conditions).
...
// QueryAllByConditions query all by conditions
func (s *nodeSerialRepo) QueryAllByConditions(ctx context.Context, conditions map[string]interface{}) ([]*po.NodeSerial, error) {
	return s.queryAllByConditions(ctx, s.dbConn, conditions)
}

// QueryAllByConditionsWithDBConn query all by conditions
func (s *nodeSerialRepo) QueryAllByConditionsWithDBConn(ctx context.Context, dbConn *gorm.DB, conditions map[string]interface{}) ([]*po.NodeSerial, error) {
...
// list 列表
func (s *nodeSerialRepo) list(ctx context.Context, dbConn *gorm.DB, conditions map[string]interface{}, paginatorArgs *gormpkg.PaginatorArgs) (dataModels []*po.NodeSerial, recordCount int64, err error) {
	// query where
	dbConn = dbConn.WithContext(ctx).Table(s.NodeSerialSchema.TableName())
...
// List 列表
func (s *nodeSerialRepo) List(ctx context.Context, conditions map[string]interface{}, paginatorArgs *gormpkg.PaginatorArgs) ([]*po.NodeSerial, int64, error) {
	return s.list(ctx, s.dbConn, conditions, paginatorArgs)
}

// ListWithDBConn 列表
func (s *nodeSerialRepo) ListWithDBConn(ctx context.Context, dbConn *gorm.DB, conditions map[string]interface{}, paginatorArgs *gormpkg.PaginatorArgs) ([]*po.NodeSerial, int64, error) {
...
// delete delete one
func (s *nodeSerialRepo) delete(ctx context.Context, dbConn *gorm.DB, dataModel *po.NodeSerial) (err error) {
	err = dbConn.WithContext(ctx).
		Table(s.NodeSerialSchema.TableName()).
		Where(schemas.FieldId+" = ?", dataModel.Id).
...
// Delete delete one
func (s *nodeSerialRepo) Delete(ctx context.Context, dataModel *po.NodeSerial) error {
	return s.delete(ctx, s.dbConn, dataModel)
}

// DeleteWithDBConn delete one
func (s *nodeSerialRepo) DeleteWithDBConn(ctx context.Context, dbConn *gorm.DB, dataModel *po.NodeSerial) error {
	return s.delete(ctx, dbConn, dataModel)
}

// deleteByIds delete by ids
func (s *nodeSerialRepo) deleteByIds(ctx context.Context, dbConn *gorm.DB, ids interface{}) (err error) {
	err = dbConn.WithContext(ctx).
		Table(s.NodeSerialSchema.TableName()).
...
// DeleteByIds delete by ids
func (s *nodeSerialRepo) DeleteByIds(ctx context.Context, ids interface{}) error {
	return s.deleteByIds(ctx, s.dbConn, ids)
}

// DeleteByIdsWithDBConn delete by ids
func (s *nodeSerialRepo) DeleteByIdsWithDBConn(ctx context.Context, dbConn *gorm.DB, ids interface{}) error {
...
// insert 批量插入
func (s *nodeSerialRepo) insert(ctx context.Context, dbConn *gorm.DB, dataModels NodeSerialSlice) error {
...
// Insert 批量插入
func (s *nodeSerialRepo) Insert(ctx context.Context, dataModels []*po.NodeSerial) error {
	return s.insert(ctx, s.dbConn, dataModels)
}

// InsertWithDBConn 批量插入
func (s *nodeSerialRepo) InsertWithDBConn(ctx context.Context, dbConn *gorm.DB, dataModels []*po.NodeSerial) error {
...
func (s *nodeSerialRepo) WhereConditions(dbConn *gorm.DB, conditions map[string]interface{}) *gorm.DB {
...
func (s *nodeSerialRepo) UpdateColumns(conditions map[string]interface{}) map[string]interface{} {
